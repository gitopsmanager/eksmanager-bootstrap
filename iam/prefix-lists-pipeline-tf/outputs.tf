...
output "prefix_lists_bucket" {
  description = "Name of the S3 bucket used for add-cluster artifacts."
  value       = aws_s3_bucket.prefix_lists.bucket
}

output "github_actions_role_arn" {
  description = "ARN to set as the AWS_ROLE_ARN repository variable for add-cluster-network.yml, for the GitHub Actions OIDC upload path."
